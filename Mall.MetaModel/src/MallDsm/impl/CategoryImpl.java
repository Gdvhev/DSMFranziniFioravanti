 ...
 * </p>
 * <ul>
 *   <li>{@link MallDsm.impl.CategoryImpl#getContains <em>Contains</em>}</li>
 *   <li>{@link MallDsm.impl.CategoryImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CategoryImpl extends EObjectImpl implements Category {
	...
	protected EClass eStaticClass() {
		return MallDsmPackage.Literals.CATEGORY;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MallDsmPackage.CATEGORY__NAME, oldName, name));
	}
