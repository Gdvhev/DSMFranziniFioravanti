...
/**
 * This is the item provider adapter for a {@link MallDsm.Brand} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class BrandItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 MallDsmPackage.Literals.BRAND__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(MallDsmPackage.Literals.BRAND__PRODUCED_GOODS);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Brand.class)) {
			case MallDsmPackage.BRAND__NAME:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case MallDsmPackage.BRAND__PRODUCED_GOODS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(MallDsmPackage.Literals.BRAND__PRODUCED_GOODS,
				 MallDsmFactory.eINSTANCE.createGood()));
	}
