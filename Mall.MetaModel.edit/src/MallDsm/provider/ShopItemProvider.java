...
/**
 * This is the item provider adapter for a {@link MallDsm.Shop} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ShopItemProvider 
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addPhotosPathsPropertyDescriptor(object);
			addMapPathPropertyDescriptor(object);
		}
	...
	/**
	 * This adds a property descriptor for the Photos Paths feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addPhotosPathsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
	...
	/**
	 * This adds a property descriptor for the Map Path feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addMapPathPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(MallDsmPackage.Literals.SHOP__HAS);
			childrenFeatures.add(MallDsmPackage.Literals.SHOP__SOLD_GOODS);
			childrenFeatures.add(MallDsmPackage.Literals.SHOP__EMPLOYEES);
			childrenFeatures.add(MallDsmPackage.Literals.SHOP__MANAGER);
			childrenFeatures.add(MallDsmPackage.Literals.SHOP__OPEN_SCHEDULE);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(MallDsmPackage.Literals.SHOP__HAS,
				 MallDsmFactory.eINSTANCE.createShelf()));

		newChildDescriptors.add
			(createChildParameter
				(MallDsmPackage.Literals.SHOP__HAS,
				 MallDsmFactory.eINSTANCE.createRefrigerator()));

		newChildDescriptors.add
			(createChildParameter
				(MallDsmPackage.Literals.SHOP__HAS,
				 MallDsmFactory.eINSTANCE.createTable()));

		newChildDescriptors.add
			(createChildParameter
				(MallDsmPackage.Literals.SHOP__SOLD_GOODS,
				 MallDsmFactory.eINSTANCE.createListedGood()));

		newChildDescriptors.add
			(createChildParameter
				(MallDsmPackage.Literals.SHOP__EMPLOYEES,
				 MallDsmFactory.eINSTANCE.createEmployee()));

		newChildDescriptors.add
			(createChildParameter
				(MallDsmPackage.Literals.SHOP__MANAGER,
				 MallDsmFactory.eINSTANCE.createEmployee()));

		newChildDescriptors.add
			(createChildParameter
				(MallDsmPackage.Literals.SHOP__OPEN_SCHEDULE,
				 MallDsmFactory.eINSTANCE.createWeeklySchedule()));
	}
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			childFeature == MallDsmPackage.Literals.SHOP__EMPLOYEES ||
			childFeature == MallDsmPackage.Literals.SHOP__MANAGER;
