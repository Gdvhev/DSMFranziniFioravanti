...
/**
 * This is the item provider adapter for a {@link MallDsm.Good} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class GoodItemProvider 
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addHasSubCategoryPropertyDescriptor(object);
	...
	/**
	 * This adds a property descriptor for the Has Sub Category feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addHasSubCategoryPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Good_hasSubCategory_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Good_hasSubCategory_feature", "_UI_Good_type"),
				 MallDsmPackage.Literals.GOOD__HAS_SUB_CATEGORY,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(MallDsmPackage.Literals.GOOD__FEATURES);
		}
	...
	public String getText(Object object) {
		String label = ((Good)object).getModelNumber();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(MallDsmPackage.Literals.GOOD__FEATURES,
				 MallDsmFactory.eINSTANCE.createFeature()));
	}
